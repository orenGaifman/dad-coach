 ...
 * <p>
 * The ToolApiAuthFilter and ContextProviderAuthFilter are explicitly added to the
 * Spring Security filter chain in SecurityConfig. This configuration prevents them
 * from also being registered as servlet filters, which would cause them to run twice.
 */
@Configuration
